    ...
    <>
      {sideVisible && (
        <div
          ...
          className="md:hidden fixed top-0 left-0 h-screen w-screen bg-tok-dark/50 z-20"
        />
      )}
      <aside
        className={`fixed top-0 left-0 z-30 flex-shrink-0 bg-white dark:bg-tok-dark-bg w-72 h-full transition-transform duration-500 border-r border-r-tok-gray dark:border-r-tok-gray/15 ${
