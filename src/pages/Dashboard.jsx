      ...
      <div className="space-y-6">
        ...
        <div className="relative overflow-x-auto rounded-lg border border-tok-gray dark:border-tok-dark-gray">
          ...
          <div className="w-full flex justify-between items-center p-4">
            <button
              className="flex max-sm:hidden justify-center items-center gap-2 bg-tok-blue text-nowrap hover:bg-tok-blue/90 transition-colors duration-300 ease text-white px-3 py-2 rounded-lg"
              type="button"
              onClick={() => {
                if (page > 1) {
                  loadTable(page - 1);
